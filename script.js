...
function screenController() {
    let myLibrary = [];
    let defaltData = new Book("The Lord of The Ring","J.R.R Tolkien","Read");
    myLibrary.push(defaltData);
    ...
    function addBookToLibrary() {
        ...
        let bookStatusTxt = "Read";
        if(bookStatus.value === "0") bookStatusTxt = "Not read"; 
        newBook = new Book(bookName.value, bookAuthor.value, bookStatusTxt);
